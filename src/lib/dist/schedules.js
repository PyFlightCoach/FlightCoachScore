...
exports.Olan = exports.safeGetLibrary = exports.loadManDef = exports.loadKnowns = exports.library = exports.ScheduleLibrary = exports.loadSchedules = exports.scheduleRepr = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, lib.update({ owner: 'admin@fcscore.org' }).then(function (newlib) { exports.library.set(newlib.sort(['rule_name', 'category_name', 'schedule_name'])); })];
                case 1:
                    _a.sent();
                    _a.label = 2;
...
function loadManDef(manoeuvre_id) {
    return __awaiter(this, void 0, Promise, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, api_1.dbServer.get("schedule/manoeuvre/definition/" + manoeuvre_id).then(function (r) { return mandef_1.ManDef.parse(r.data); })];
        });
    });
}
