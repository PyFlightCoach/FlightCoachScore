<script lang="ts">
	...
	let lg = $derived($windowWidth >= 1024);
</script>
...
<div
	...
	class="{!lg
		...
		: 'col-lg-2'} bg-light border overflow-scroll b-0"
>
	<div class="row px-2 mt-2">
		<CheckInput name="Show Add Pilot" bind:checked={showAddPilot} />
	</div>
</div>

<div class="col-lg-10 px-0 justify-content-center text-center">
