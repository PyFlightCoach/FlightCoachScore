...
<div class="col-md-3 pt-5">
	...
	<li class="input-group">
		...
		<select class="form-select" id="set-privacy" bind:value={privacy}>
	...
	<div class="input-group">
		...
		<textarea id="comments" class="form-control" name="comments" rows="2" bind:value={comment}
		></textarea>
	</div>
